...
function Nav({ onClick, volumeData, playClickSound }: { onClick?: () => void; volumeData: [number, React.Dispatch<React.SetStateAction<number>>], playClickSound: any }) {
  return (
    <div className='absolute top-[5vw] flex w-full justify-between px-3'>
        ...
        <button className='p-2 bg-blue-500 rounded-full' onClick={() => volumeData[1]((prev: number) => prev ? 0 : 1)}>
